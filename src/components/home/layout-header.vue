  ...
  methods: {
    ...
    // 需要处理三种情况
      ...
      // 点击个人信息的时候
        ...
        // 如果点击了git地址就跳转到git仓库
        window.location.href = 'https://github.com/Xiaokai-j/Headlines.git'
      } else {
      // 退出系统 1、删除token 2、跳转回登录界面
      // 删除  localStorage  中的某个选项
